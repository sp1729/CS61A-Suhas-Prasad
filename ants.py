...
class ThrowerAnt(Ant):
    ...
    food_cost = 3
    min_range, max_range = -1, float('inf')
    ...
    def nearest_bee(self, beehive):
        ...
        loc, spaces = self.place, self.min_range
        for i in range(spaces):
            if loc is beehive:
                return None
            loc = loc.entrance
        while loc != beehive and spaces <= self.max_range:
            if loc.bees:
                return rANTdom_else_none(loc.bees)
            spaces += 1
            loc = loc.entrance
        return None
        # END Problem 3 and 4
...
class ShortThrower(ThrowerAnt):
    ...
    armor, min_range, max_range = 1, 0, 3
    # END Problem 4
...
class LongThrower(ThrowerAnt):
    ...
    # BEGIN Problem 4
    implemented = True   # Change to True to view in the GUI
    armor, min_range, max_range = 1, 5, float('inf')
    # END Problem 4
...
class HungryAnt(Ant):
    ...
    def action(self, gamestate):
        ...
        if self.digesting:
            self.digesting -= 1
        elif rANTdom_else_none(loc.bees): self.eat_bee(rANTdom_else_none(loc.bees))
...
# END Problem 13
    ...
    def __init__(self, armor=1):
        ...
        if QueenAnt.queen_place is None:
            QueenAnt.queen_place = self
        # END Problem 13
    ...
    def action(self, gamestate):
        ...
        """
        # BEGIN Problem 13
        if self.queen_place is not self: 
            ...
            while loc is not None:
                if loc.ant:
                    if isinstance(loc.ant, ContainerAnt):
                            if loc.ant.contained_ant:
                                if not loc.ant.contained_ant.been_doubled:
                                    loc.ant.contained_ant.damage *= 2
                                    loc.ant.contained_ant.been_doubled = True
                    if not loc.ant.been_doubled:
                        loc.ant.damage*=2
                        loc.ant.been_doubled = True
                loc = loc.exit
        # END Problem 13
